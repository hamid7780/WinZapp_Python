...
export function createRouter(manager: BaileysManager): Router {
  ...
  router.post('/api/:session/send-file', authCheck, upload.single('file'), async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  router.post(['/api/:session/send-file-base64', '/api/:session/send-image'], authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Send Seen
  router.post('/api/:session/send-seen', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Send Mute
  router.post('/api/:session/send-mute', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Pin / Unpin Chat
  router.post('/api/:session/pin-chat', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Archive Chat
  router.post('/api/:session/archive-chat', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Clear Chat
  router.post('/api/:session/clear-chat', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
      const { phone } = req.body || {};
      const phoneVal = Array.isArray(phone) ? phone[0] : phone;
  ...
  // Delete Chat
  router.post('/api/:session/delete-chat', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
      const { phone } = req.body || {};
      const phoneVal = Array.isArray(phone) ? phone[0] : phone;
  ...
  // Blocklist
  router.get('/api/:session/blocklist', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  router.post('/api/:session/block-contact', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
      const { phone } = req.body || {};
  ...
  router.post('/api/:session/unblock-contact', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
      const { phone } = req.body || {};
  ...
  router.post('/api/:session/typing', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  router.post('/api/:session/recording', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
      const { phone, value } = req.body || {};
  ...
  // Last Seen
  router.get('/api/:session/last-seen/:phone', authCheck, async (req: Request, res: Response) => {
    try {
      const { session, phone } = req.params;
  ...
  router.get('/api/:session/profile-status/:phone', authCheck, async (req: Request, res: Response) => {
    try {
      const { session, phone } = req.params;
  ...
  // Leave Group
  router.post('/api/:session/leave-group', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  router.post('/api/:session/add-participant-group', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  router.post('/api/:session/delete-message', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Edit Message
  router.post('/api/:session/edit-message', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Forward Messages
  router.post('/api/:session/forward-messages', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
  ...
  // Contact VCard
  router.post('/api/:session/contact-vcard', authCheck, async (req: Request, res: Response) => {
    try {
      const { session } = req.params;
